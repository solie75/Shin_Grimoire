...
- intrigue
	...
	- 모의하다, 음모를 꾸미다.
- Heuristic
	- 불충분한 정보나 시간 제약 속에서 빠르고 효율적으로 판단하고 문제를 해결하기 위해 사용하는 경험적이고 직관적인 간편법, 지름길, 또는 어림짐작 방법이다. 
	- 예를 들어 100 점짜리 정답을 맞추느라 10시간을 끄는 대신 90 점 짜리 정답을 10분 만에 찾아내는 스마트한 요령 이라고 할 수 있다.
- credential
	- 자격 증명
- informative
	- 유익한, 지식을 주는
